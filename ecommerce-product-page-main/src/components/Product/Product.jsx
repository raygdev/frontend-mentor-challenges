  ...
  return (
    <main className={styles.wrapper}>
        <div className={styles.product__image__wrapper}>
            ...
            { !isMobile && <img className={styles.product__image} src={images[0][0]} alt='product image'/>}
        </div>
        <div className={styles.product__info__wrapper}>
            ...
            <div className={styles.product__price}>
                ...
                <span className={styles.product__total__cost}>${totalCost}</span>
                    ...
                    <span className={styles.product__regular__price}>${regularPrice}</span>
            </div>
            <div className={styles.buttons__wrapper}>
                <div className={styles.quantity__wrapper}>
                    <button aria-label='decrease quantity' className={styles.minus}></button>
                    <span className={styles.count}>0</span>
                    <button aria-label='increase quantity' className={styles.plus}></button>
                </div>
